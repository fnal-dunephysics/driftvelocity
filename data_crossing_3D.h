...
#ifndef data_crossing_3D_h
#define data_crossing_3D_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   data_crossing_3D(TTree *tree=0);
   virtual ~data_crossing_3D();
...
#ifdef data_crossing_3D_cxx
data_crossing_3D::data_crossing_3D(TTree *tree) : fChain(0) 
{
...
data_crossing_3D::~data_crossing_3D()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t data_crossing_3D::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t data_crossing_3D::LoadTree(Long64_t entry)
{
...
void data_crossing_3D::Init(TTree *tree)
{
...
Bool_t data_crossing_3D::Notify()
{
...
void data_crossing_3D::Show(Long64_t entry)
{
...
Int_t data_crossing_3D::Cut(Long64_t entry)
{
...
#endif // #ifdef data_crossing_3D_cxx
