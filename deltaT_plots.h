...
#ifndef deltaT_plots_h
#define deltaT_plots_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   deltaT_plots(TTree *tree=0);
   virtual ~deltaT_plots();
...
#ifdef deltaT_plots_cxx
deltaT_plots::deltaT_plots(TTree *tree) : fChain(0) 
{
...
deltaT_plots::~deltaT_plots()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t deltaT_plots::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t deltaT_plots::LoadTree(Long64_t entry)
{
...
void deltaT_plots::Init(TTree *tree)
{
...
void deltaT_plots::Show(Long64_t entry)
{
...
Int_t deltaT_plots::Cut(Long64_t entry)
{
