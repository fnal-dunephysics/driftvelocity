...
#ifndef velocity_code_h
#define velocity_code_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   velocity_code(TTree *tree=0);
   virtual ~velocity_code();
...
#ifdef velocity_code_cxx
velocity_code::velocity_code(TTree *tree) : fChain(0) 
{
...
Int_t velocity_code::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t velocity_code::LoadTree(Long64_t entry)
{
...
void velocity_code::Init(TTree *tree)
{
...
void velocity_code::Show(Long64_t entry)
{
...
Int_t velocity_code::Cut(Long64_t entry)
{
